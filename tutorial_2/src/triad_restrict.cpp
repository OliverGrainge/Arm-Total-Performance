...
// Triad with __restrict__ contracts. This tells the compiler that out, a,
// and b do not overlap, enabling clean vectorization of the hot loop.
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "Restrict triad  N=" << n << " iters=" << iters << "\n";
    std::cout << "  Time:       " << ms << " ms\n";
